# Agentic RAG-Based Smart Faculty Evaluation System

An AI-powered Smart Faculty Evaluation System built using **Agentic AI**, **Retrieval-Augmented Generation (RAG)**, **Hybrid Search**, **SQL Query Generation**, and **Large Language Models (LLMs)**. The system enables users to interact using natural language and retrieves insights related to faculty performance, student ratings, attendance, marks, and academic analytics.
